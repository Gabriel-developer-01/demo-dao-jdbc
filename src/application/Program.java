...
/*ATENÇÃO: ESSA CLASSE FOI CRIADA COMO DESAFIO PARA MIM EXERCITAR,FIZ UM MENU PARA JUNTAR O PROGRAM1 E O PROGRAM2*/
	public static void main(String[] args) {

		Scanner sc = new Scanner(System.in);
		
		//chamada no meu menu para escolher Department ou Seller
